...
PBKDF2-HMAC-SHA256 from the standard library — zero third-party deps, so the
Lambda package stays pure-Python (no native wheels). PBKDF2 with a high iteration
count is OWASP-recommended.
